...
from transactions.hospital_settings.fetch_hospital_settings_transaction import (
    fetch_hospital_settings_transaction
)
...
def fetch_init_inspection_execution(
    ...
    room_infections = fetch_room_infections(
        client,
        hospital_id,
    )

    infection_types = fetch_infection_types(
        client,
        hospital_id,
    )
    ...
    inspection_checklists = fetch_inspection_checklists(
        client,
        hospital_id,
    )

    inspection_item_categories = fetch_inspection_item_categories(
        client,
        hospital_id,
    )

    inspection_item_types = fetch_inspection_item_types(
        client,
        hospital_id,
    )
